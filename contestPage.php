...
var countdownTimer = setInterval('secondPassed()', 1000);
 	...
 	<?php 
 		if (isset($_SESSION['userName'])) {
 			...
 			$sql = "SELECT * FROM round1 WHERE participant = '$participant'";
    ...
    $result = mysqli_query($conn,$sql);
      while($row = $result->fetch_assoc())
      {
        ...
        echo '<img src="images/'.$fileName.'" width="200px" height="200px" alt="">';
      	echo '<h6>'.$question.'</h6>';
      	echo '<form method="POST" action="answerCheck.php">
      ...
      echo '<button type="submit" name="submit" id="btn">Submit</button></form>';
 		...
 		{
 			echo '<form class="form-signin" style="margin: 10px; margin-top: 0px;" action="includes/login.inc.php" method="POST">
